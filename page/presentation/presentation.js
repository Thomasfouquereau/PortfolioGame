...
p.textContent = 'tu peux utiliser l inventaire pour utiliser les object que tu a trouver';

let img = document.createElement('img');
img.setAttribute('id', 'tuto-img');
img.setAttribute('src', '../../asset/inventaire img.svg');
...
buttonTerminer.addEventListener('click', () => {
    ...
    gsap.to(tuto, { y: -600, duration: 0.8 })
});
